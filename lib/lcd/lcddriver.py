...
# i.e. not imported as a module. Uncomment whichever size for a quick test.
if __name__ == "__main__":
	...
	# for 20x4
	#lcd.lcd_display_string("    It works! :)    ", 1)
	#lcd.lcd_display_string("Now make some coffee", 2)
	#lcd.lcd_display_string("and write more code!", 3)
